...
def plot_boxplot(output_dir, positives, negatives):
    ...
    Args:
        output_dir (Path or str): Directory where the output file
                                  will be saved.
...
def plot_separate_distributions(output_dir, input_file):
    ...
    Args:
        ...
        input_file (dict): Dictionary with model evaluation results.
    """
...
def sort_results(results_file, data_file):
    ...
    Args:
        results_file (dict): Dictionary containing the evaluation results.
...
def save_quartile_items(output_dir, results, set_name):
    ...
    Args:
        ...
        results (list of dicts): List of data points sorted by
                                 prediction value.
    """
    n = len(results)
    q1_index = n // 4
